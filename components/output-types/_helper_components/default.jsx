      ...
      <body>
        ...
        {connextIsEnabled && (
          <>
            ...
            <script type="text/javascript" src={`${fullPathDomain}${deployment(`${contextPath}/resources/scripts/naviga/${connextEnv}/Connext.min.js`)}`}></script>
            <link rel="stylesheet" href={`${fullPathDomain}${deployment(`${contextPath}/resources/scripts/naviga/${connextEnv}/Connext.min.css`)}`} />
            <script type="text/javascript" src={`${fullPathDomain}${deployment(`${contextPath}/resources/scripts/naviga/${connextEnv}/fp.min.js`)}`}></script>
            <script type="text/javascript" src={`${fullPathDomain}${deployment(`${contextPath}/resources/scripts/naviga/${connextEnv}/g2i.min.js`)}`}></script>
