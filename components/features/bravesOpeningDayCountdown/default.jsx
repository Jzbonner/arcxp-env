...
export const BravesOpeningDayCountdown = ({ tags = [], storyPage = false }) => {
  ...
  const countDownTime = 1649377200000; // equivalent to `Date('2022-04-07 20:20:00-04:00').getTime()` but that format is invalid for iOS Safari (because of course) so I'm just using the timestamp directly
  const now = new Date();
