        ...
        <div className={`subNav ${isMobile && showUserMenu ? 'isVisible' : ''}`}>
          ...
          <ul className={'subNav-flyout'}>
            ...
            {arcSite !== 'dayton' && <li className={'flyout-item'}>
              <a href={`https://epaper.${handleSiteName(arcSite)}.com/default.aspx?acc=cmg&pub=${siteCode}&date=&section=Main&EntitlementCode=epaperHTML5&custregid=${userId}`} target='_blank' rel="noopener noreferrer">
                ePaper
              </a>
            </li>}
            <li className={'flyout-item'}>
