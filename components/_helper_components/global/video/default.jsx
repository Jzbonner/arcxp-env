...
const Video = ({
  ...
  const ampIframe = () => (
    ...
    <amp-iframe
    layout="responsive"
    src={`https://${orgOfRecord}.video-player.arcpublishing.com/${currentEnv}/powaEmbed.html?org=${orgOfRecord}&uuid=${vidId}&powa-ad-tag=${encodedAdTag}&autoinit=native-hls&playthrough=true&discovery=true&${!isInlineVideo ? 'powa-autoplay=true&powa-muted=true' : ''}`}
    width={`${vidWidth}`}
    height={`${vidHeight}`}
    allow='autoplay'
