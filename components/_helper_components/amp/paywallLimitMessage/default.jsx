...
const PaywallLimitMessage = () => <div className="c-section inline-body subscribe-bar" id="paywallContainer" amp-access="Error != true AND AccessLevel = 'Fallback_EmptyReaderId' OR AccessLevel = 'Page View Limit' OR AccessLevel != 'Full Content Access'" amp-access-hide>
