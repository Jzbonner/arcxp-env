...
const PaywallLimitMessage = () => <div className="c-section inline-body subscribe-bar" id="paywallContainer">
  <div className="custom-tmpl-wrapper" id="inlineSubscribe" amp-access='Error=false AND AccessLevel!="Full Content Access"' amp-access-hide>
    ...
    <div className="row center btn-container" data-nxt-template-substep="SubstepName">
      <a on="tap:amp-access.login-SubscribeInMarket" data-mg2-action="click" className="btn-link" data-mce-href="{{Subscribe}}" amp-access='UserState!="Subscribed"' amp-access-hide>
